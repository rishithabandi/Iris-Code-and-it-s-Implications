...
public class Subject
{
	...
	/**
	 * Returns the Iris Code of the subject.
	 *
	 * @return the iriscode
	 */
	...
	/**
	 * Sets the Iris Code of the subject.
	 *
	 * @param iCode The iris code
	 */
	public void setIrisCode(String [] iCode)
	{
		this.irisCode = iCode;
	}
